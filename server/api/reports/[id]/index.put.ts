...
export default defineEventHandler(async (event) => {
  ...
  const { status, schoolYear, introduction, competences, showCoverPage, coverHeaderSize, reportFontSize, reportLayout } = await readValidatedBody(event, bodySchema.parse)
